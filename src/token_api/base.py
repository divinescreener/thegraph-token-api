...
from .types import VersionResponse, NetworksResponse
...
class BaseTokenAPI:
    ...
    def __init__(
        ...
        self.base_url = (base_url or 
                        os.getenv("THEGRAPH_API_ENDPOINT", "https://token-api.thegraph.com"))
    ...
    async def get_networks(self) -> NetworksResponse:
        ...
        response = await self.manager.get(
            ...
            headers=self._headers,
            expected_type=NetworksResponse
        )
        return response.data