...
from token_api.simple import TokenAPI, NFTWrapper, EVMWrapper, SVMWrapper
...
class TestTokenAPIInitialization:
    ...
    def test_initialization_with_api_key(self):
        ...
        assert api._api.api_key == "test_key"
    ...
    def test_initialization_with_env_api_key(self):
        ...
        with patch.dict('os.environ', {'THEGRAPH_API_KEY': 'env_key'}):
            ...
            assert api._api.api_key == "env_key"
...
class TestEVMInternalMethods:
    ...
    async def test_evm_balances_with_network(self):
        ...
        with patch.object(api._api, 'evm') as mock_evm:
            ...
            result = await api._evm_balances(
                address="0xtest", 
                contract="0xtoken", 
                limit=20, 
                network="polygon"
            ...
            mock_client.get_balances.assert_called_with(
                address="0xtest", contract="0xtoken", limit=20
            )
    ...
    async def test_evm_price_history(self):
        ...
        with patch.object(api._api, 'evm') as mock_evm:
            ...
            with patch('datetime.datetime') as mock_datetime_class:
                with patch('datetime.timedelta') as mock_timedelta_class:
    ...
    async def test_evm_token_holders(self):
        ...
        with patch.object(api._api, 'evm') as mock_evm:
            ...
            result = await api._evm_token_holders(
                contract="0xtoken",
                limit=100,
                network="bsc"
            )
