...
class TestEnumStringConversions:
    ...
    def test_network_id_string_conversion(self):
        ...
        for network in [NetworkId.MAINNET, NetworkId.MATIC, NetworkId.BSC, 
                       NetworkId.ARBITRUM_ONE, NetworkId.OPTIMISM, NetworkId.AVALANCHE,
                       NetworkId.BASE, NetworkId.UNICHAIN]:
    ...
    def test_swap_programs_string_conversion(self):
        ...
        for program in [SwapPrograms.RAYDIUM, SwapPrograms.PUMP_FUN_CORE,
                       SwapPrograms.JUPITER_V4, SwapPrograms.JUPITER_V6, SwapPrograms.PUMP_FUN_AMM]:
            assert isinstance(str(program), str)
            assert str(program) == program.value
