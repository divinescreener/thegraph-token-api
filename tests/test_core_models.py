...
from token_api.models import (
    convert_to_model, convert_list_to_models, BaseModel,
    Balance, Swap, SolanaSwap, Token, NFTCollection, NFTOwnership, Pool,
    Transfer, NFTActivity
)
from token_api.types import ActivityType, TokenStandard
...
class TestModelConversion:
    ...
    def test_convert_to_model_solana_swap_nested_mints(self):
        ...
        data = {
            ...
            "output_mint": {"address": "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", "symbol": "USDC", "decimals": 6.0},
            "input_amount": 10.5,
